...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="libs/leaflet_marker_cluster/dist/MarkerCluster.css">
		<link rel="stylesheet" href="libs/leaflet_marker_cluster/dist/MarkerCluster.Default.css">
		<link rel="stylesheet" href="libs/leaflet_ruler/src/leaflet-ruler.css">
		...
		<script src="libs/leaflet_ruler/src/leaflet-ruler.js"></script>
		<script src="libs/jquery/jquery-ui-1.12.1.custom/jquery-ui.js"></script>
		<script src="libs/leaflet_routing_machine/dist/leaflet-routing-machine.min.js"></script>
		<script src="libs/leaflet_accurate_position/Leaflet.AccuratePosition.js"></script>
		<script src="libs/r360/dist/r360.js"></script>
	...
	<body>
		...
		<div class="row">
				...
				<div class="col-10">
					<div><button id="myLocation" class="mylocation" onclick="currentLocation()">Ma position</button>
					</div>
 					<div id="macarte" style="width:80%; height:500px">
		 			</div>
		 </div>
        			...
        			if (navigator.geolocation) {
                		...
                		var marker = L.marker([position.coords.latitude, position.coords.longitude]).addTo(carte);
                		marker.bindPopup("Vous êtes ici :<br> Latitude : " + position.coords.latitude + ',<br>Longitude ' + position.coords.longitude).openPopup();
           				}), function(error){
           					// console.log(error);
           					alert(error.message);
           				});
